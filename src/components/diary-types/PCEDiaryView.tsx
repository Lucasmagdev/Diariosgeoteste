          ...
          <PdfRow
            ...
            value={
              <div className="grid grid-cols-2 gap-3 w-full text-[7px] leading-[10px]">
                <span className="whitespace-nowrap">{pceDetail.abastecimento_chegou_diesel === true ? '\u2611' : '\u2610'} Sim</span>
                <span className="whitespace-nowrap">{pceDetail.abastecimento_chegou_diesel === false ? '\u2611' : '\u2610'} Não</span>
              </div>
            }
          />
