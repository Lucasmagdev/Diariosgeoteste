...
-- A assinatura e os demais dados continuam sempre no sistema, sem gate
-- (o PIN so afeta a liberacao do file_url de documentos 'relatorio').
-- Execute no SQL Editor do Supabase apos create_client_portal.sql.
-- =====================================================================

alter table public.obras add column if not exists relatorio_pin text;

-- ---------------------------------------------------------------------
-- Atualiza portal_get_data: documentos 'relatorio' com pin definido nao
-- retornam file_url direto; vem com locked=true e o cliente precisa
-- chamar portal_open_document com o PIN pra receber a url.
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- RPC: cliente informa o PIN pra liberar a url de um documento 'relatorio'
-- ---------------------------------------------------------------------
